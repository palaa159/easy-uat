...
export default {
    data: () => ({
      list: [
          ...
          'การเข้ามาใช้งานเว็บไซต์ของบริษัท (maplelife.co.th) และการดำเนินธุรกรรมใดๆ กับทางบริษัทถือว่าทางลูกค้า และผู้ที่ดำเนินธุรกรรมดังกล่าวได้ยินยอมให้ทางบริษัทสามารถจัดเก็บข้อมูลที่เกี่ยว	กับลูกค้าและผู้ที่ดำเนินธุรกรรมดังกล่าวเพื่อนำไปใช้ในกิจกรรมการตลาดโดยบริษัท หรือโดย	พันธมิตรทางการค้าของบริษัท',
